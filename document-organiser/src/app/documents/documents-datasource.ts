...
/**
 * Data source for the Documents view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class DocumentsDataSource extends DataSource<DocumentsItem> {
  data: DocumentsItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<DocumentsItem[]> {
   ...
   */
  private getPagedData(data: DocumentsItem[]): DocumentsItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DocumentsItem[]): DocumentsItem[] {
