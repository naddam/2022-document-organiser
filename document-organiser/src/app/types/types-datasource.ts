...
const EXAMPLE_DATA: TypesItem[] = [
  {name: 'ExampleDoc', id: 'ExampleID', owner: 'Example Owner', doctype: 'Example Type', expires_at: date, download: 'exampleLink'}
];

/**
 * Data source for the Types view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class TypesDataSource extends DataSource<TypesItem> {
  data: TypesItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: TypesItem[]): TypesItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TypesItem[]): TypesItem[] {
